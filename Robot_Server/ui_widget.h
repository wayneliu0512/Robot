...
public:
    ...
    QListWidget *listWidget_Box1;
    QGroupBox *groupBox_3;
    QLabel *pixmap_Box2;
    QLCDNumber *lcdNumber_Box2;
    QListWidget *listWidget_Box2;
    QGroupBox *groupBox_4;
    QLabel *pixmap_Box3;
    QLCDNumber *lcdNumber_Box3;
    QListWidget *listWidget_Box3;
    QGroupBox *groupBox;
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(20, 120, 631, 171));
        ...
        pixmap_Box1->setGeometry(QRect(10, 30, 51, 51));
        QFont font1;
        ...
        lcdNumber_Box1->setGeometry(QRect(90, 40, 91, 31));
        lcdNumber_Box1->setSegmentStyle(QLCDNumber::Flat);
        lcdNumber_Box1->setProperty("intValue", QVariant(0));
        listWidget_Box1 = new QListWidget(groupBox_2);
        listWidget_Box1->setObjectName(QStringLiteral("listWidget_Box1"));
        listWidget_Box1->setGeometry(QRect(10, 90, 171, 71));
        ...
        pixmap_Box2->setGeometry(QRect(10, 30, 51, 51));
        ...
        lcdNumber_Box2->setGeometry(QRect(90, 40, 91, 31));
        lcdNumber_Box2->setSegmentStyle(QLCDNumber::Flat);
        listWidget_Box2 = new QListWidget(groupBox_3);
        listWidget_Box2->setObjectName(QStringLiteral("listWidget_Box2"));
        listWidget_Box2->setGeometry(QRect(10, 90, 171, 71));
        ...
        pixmap_Box3->setGeometry(QRect(10, 30, 51, 51));
        ...
        lcdNumber_Box3->setGeometry(QRect(90, 40, 91, 31));
        lcdNumber_Box3->setSegmentStyle(QLCDNumber::Flat);
        listWidget_Box3 = new QListWidget(groupBox_4);
        listWidget_Box3->setObjectName(QStringLiteral("listWidget_Box3"));
        listWidget_Box3->setGeometry(QRect(10, 90, 171, 71));
        ...
        pixmap_Barcode->setGeometry(QRect(10, 30, 51, 51));
