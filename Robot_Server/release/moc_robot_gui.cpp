...
QT_MOC_LITERAL(3, 21, 12), // "Robot::State"
QT_MOC_LITERAL(4, 34, 18), // "flashYellowTimeout"
QT_MOC_LITERAL(5, 53, 17), // "flashGreenTimeout"
QT_MOC_LITERAL(6, 71, 15) // "flashRedTimeout"

    },
    "Robot_GUI\0updateGUI\0\0Robot::State\0"
...
void Robot_GUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->flashYellowTimeout(); break;
        case 2: _t->flashGreenTimeout(); break;
        case 3: _t->flashRedTimeout(); break;
        default: ;
        }
    }
}

const QMetaObject Robot_GUI::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Robot_GUI.data,
      qt_meta_data_Robot_GUI,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Robot_GUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Robot_GUI.stringdata0))
        return static_cast<void*>(const_cast< Robot_GUI*>(this));
