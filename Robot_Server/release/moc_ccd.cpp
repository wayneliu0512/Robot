/****************************************************************************
** Meta object code from reading C++ file 'ccd.h'
**
...
#error "The header file 'ccd.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 4, 9), // "updateGUI"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 10), // "CCD::State"
QT_MOC_LITERAL(4, 26, 21), // "updateConnectionState"
QT_MOC_LITERAL(5, 48, 24), // "CCD_Communication::State"
QT_MOC_LITERAL(6, 73, 6) // "_state"

    },
    "CCD\0updateGUI\0\0CCD::State\0"
    "updateConnectionState\0CCD_Communication::State\0"
    "_state"
};
...
void CCD::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateConnectionState((*reinterpret_cast< CCD_Communication::State(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CCD::*_t)(CCD::State );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CCD::updateGUI)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CCD::updateGUI(CCD::State _t1)
{
